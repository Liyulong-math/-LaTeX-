...
% 学院
\newcommand{\school}{数学与计算科学学院 | College of Mathematics and Computer Science} 
...
\newcommand{\contact}{
    ...
    \textcolor{white}{
        % 邮箱
        \faEnvelope \quad \href{mailto:youremail@nbu.edu.cn}{youremail@xtu.edu.com}
        \hspace{4em}
        % 手机号
        \faPhone \quad  158-0000-0000
        % 别的联系方式，如微信、GitHub等
        \hspace{4em}
...
\begin{document}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[opacity=0.05] at(current page.center){
            \includegraphics[width=0.7\paperwidth, keepaspectratio]{images/湘大校徽.jpg}
        };
    \end{tikzpicture}
    ...
    \begin{minipage}[t]{0.78\textwidth}
        ...
        {\large \textbf{湘潭大学}}\qquad\textbf{双一流院校} \qquad GPA排名：x/xxx \hfill 2023年9月--2027年6月
        \begin{itemize}
            \item 数学与计算科学学院 \qquad 信息与计算科学（双一流专业）
    ...
    \begin{minipage}[t]{0.2\textwidth}
        ...
        \doublebox{\includegraphics[width=\linewidth]{images/示意图.png}}
    \end{minipage}

    \begin{minipage}[t]{\textwidth}
    % 科研竞赛
    \section[科研竞赛]{\makebox[\iconwidth][c]{\color{primary_color}{\faAtom}}\quad 科研成果}

    % 科研著作
    获得了何种教育部认定的A类比赛奖项 \hfill  \textbf{国家级一等奖}（A类）
    \begin{itemize}

        \item 详细地描述你在竞赛中做了哪些工作 \dots\dots
    \end{itemize}

    \vspace{0.5em}
    竞赛或实践项目
    \begin{itemize}
        \item  \textbf{你的名字}、你的师兄、你的导师 \hfill 获得奖项或发表于 \textbf{某篇期刊} 
        \item 详细地描述你在这份论文上的学习收获（可以继续添加奖项）\dots\dots
    \end{itemize}
    ...
    \section[项目与实践]{\makebox[\iconwidth][c]{\color{primary_color}{\faChalkboardTeacher}}\quad 项目与实践}
    
    {\large \textbf{项目名称}} \hfill 2024年9月--2025年9月
    \begin{itemize}
    ...
    \vspace{0.5em}
    {\large \textbf{某讨论班}}，主讲 / 参与 \hfill 2024年夏季
    \begin{itemize}
  ...
  \vspace{1em}
    \begin{minipage}[t]{\textwidth}
        ...
        \setlength{\itemsep}{0.5em}
            \item 掌握 Python、Matlab 等编程语言的数值计算方法、可视化方法。
            \item 拥有参与使用 Tensorflow、Pytorch 等深度学习框架的项目经历。
            \item 切忌没有自信不能写“熟练”掌握某种技能
        \end{itemize}
    \end{minipage}
    \vspace{0.5em}
